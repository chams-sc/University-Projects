...
public class Withdraw extends javax.swing.JFrame {
    ...
    public Withdraw(String AccID, int bal, int pin) {
        initComponents();
        this.AccID = AccID;
        this.bal = bal;
        this.pin = pin;
    ...
    private void initComponents() {
        ...
        lblWithdraw.setFont(new java.awt.Font("Bahnschrift", 1, 60)); // NOI18N
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addGap(24, 24, 24)
                .addComponent(lblWithdraw, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//Submit
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	...
    	if(txtAmount.getText().isEmpty() || amount > bal) {
    		...
    		try {
    			...
    			ps.executeUpdate();
    			JOptionPane.showMessageDialog(this, "Successful withdraw of " + amount);
    			txtAmount.setText("Amount");
    			conn.close();
    		}
    		catch (Exception e) {
