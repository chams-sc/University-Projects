 ...
 * @author User
 */
public class AdmConfirmTrans extends JFrame {  
    
    /**
     * Creates new form AddFees
     */
    public AdmConfirmTrans() {
        initComponents();      
        setTitle("Cash-VSU");
    ...
    public AdmConfirmTrans(String adminPass) {
    ...
    private boolean verifyFields(){
        return !(txtFeeCode.getText().isEmpty() || String.valueOf(txtAdminPass.getPassword()).isEmpty() || date == null);
    }
    ...
    private void initComponents() {
        ...
        lblConfirmTran = new javax.swing.JLabel();
        ...
        panelBackLayout.setHorizontalGroup(
            ...
            .addComponent(btn_Back, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
        );
        ...
        panelSearchRecLayout.setHorizontalGroup(
            ...
            .addComponent(btn_SearchRecord, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
        );
        ...
        panelParent.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 390, 160, 50));

        jLabel4.setFont(new java.awt.Font("Sylfaen", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Enter Fee Code :");
        panelParent.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 160, 50));
        panelParent.add(dateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 320, 50));

        jLabel5.setFont(new java.awt.Font("Sylfaen", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Date Paid          :");
        panelParent.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, 160, 50));
        panelParent.add(txtFeeCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 250, 320, 50));

        btn_ConfirmTH.setFont(new java.awt.Font("Sylfaen", 0, 14)); // NOI18N
        btn_ConfirmTH.setText("Confirm Transaction");
        ...
        panelParent.add(btn_ConfirmTH, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 500, 160, 40));
        panelParent.add(txtAdminPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 320, 50));

        lblConfirmTran.setFont(new java.awt.Font("Timeline", 0, 48)); // NOI18N
        lblConfirmTran.setForeground(new java.awt.Color(255, 255, 153));
        lblConfirmTran.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblConfirmTran.setText("Confirm Transaction");
        panelParent.add(lblConfirmTran, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 470, 80));
    ...
    private void btn_ConfirmTHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ConfirmTHActionPerformed
        ...
        if (verifyFields() == false){
            ...
            if(String.valueOf(txtAdminPass.getPassword()).equals(adminPass)){
                try{
                    // connect to database
                    conn = FpsDBConnection.dbConnect();

                    String cquery = "SELECT FeeCode FROM tbl_pending WHERE FeeCode = '"+txtFeeCode.getText()+"'";
                    PreparedStatement cps = conn.prepareStatement(cquery);
                    ResultSet rs = cps.executeQuery();

                    if(rs.next()){
                        String query = "INSERT INTO transaction_history (FeeCode, StudentNum, Category, Amount, DueDate, DatePaid) SELECT FeeCode, StudentNum, Category, Amount, DueDate, ? FROM tbl_fee_list WHERE FeeCode = ?";                                  
                        PreparedStatement ps = conn.prepareStatement(query);
                        ps.setString(1, date);
                        ps.setString(2, txtFeeCode.getText());
                        ps.executeUpdate();

                        String query2 = "DELETE FROM tbl_fee_list WHERE FeeCode = '"+txtFeeCode.getText()+"'";
                        PreparedStatement ps2 = conn.prepareStatement(query2);         
                        ps2.executeUpdate();  

                        String query3 = "DELETE FROM tbl_pending WHERE FeeCode = '"+txtFeeCode.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdmConfirmTrans().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblConfirmTran;
