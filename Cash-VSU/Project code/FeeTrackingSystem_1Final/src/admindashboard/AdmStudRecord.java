...
public class AdmStudRecord extends JFrame {

    /**
     * Creates new form AddFees
     */
    public AdmStudRecord() {
        initComponents();   
        grabData();      
        setTitle("Cash-VSU");
    ...
    public AdmStudRecord(String adminPass) {
    ...
    private void grabData(){
        ...
        try{
            ...
            String query = "SELECT StudentNum AS 'Student No.', FirstName AS 'First Name', MiddleName AS 'Middle Name', LastName AS 'Last Name', Age, Course, Section, Email FROM tbl_user";
            PreparedStatement ps = conn.prepareStatement(query);
            ResultSet rs = ps.executeQuery();
            tblStudRec.setModel(DbUtils.resultSetToTableModel(rs));
        }
    ...
    private void initComponents() {
        ...
        tblStudRec = new javax.swing.JTable();
        ...
        panelCoursesListLayout.setHorizontalGroup(
            ...
            .addGroup(panelCoursesListLayout.createSequentialGroup()
                .addComponent(btn_ConfirmTransaction, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelHomeLayout.setHorizontalGroup(
            ...
            .addComponent(btn_Home, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
        );
        ...
        tblStudRec.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblStudRec.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_NEXT_COLUMN);
        tblStudRec.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jScrollPane1.setViewportView(tblStudRec);

        panelParent.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 680, 470));

        lblStudRec.setFont(new java.awt.Font("Timeline", 0, 48)); // NOI18N
        lblStudRec.setForeground(new java.awt.Color(255, 255, 153));
        lblStudRec.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblStudRec.setText("Student Records");
        panelParent.add(lblStudRec, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 420, 80));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdmStudRecord().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblStudRec;
